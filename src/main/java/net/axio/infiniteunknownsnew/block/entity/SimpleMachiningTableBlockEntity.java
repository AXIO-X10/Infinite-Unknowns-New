...
public class SimpleMachiningTableBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public SimpleMachiningTableBlockEntity(BlockPos position, BlockState state) {
		super(InfiniteUnknownsNewModBlockEntities.SIMPLE_MACHINING_TABLE.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return Component.literal("simple_machining_table");
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new SimpleMachiningTableGUIMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}
