package net.axio.infiniteunknownsnew;
...
@Mod("infinite_unknowns_new")
public class InfiniteUnknownsNewMod {
	public static final Logger LOGGER = LogManager.getLogger(InfiniteUnknownsNewMod.class);
	public static final String MODID = "infinite_unknowns_new";

	public InfiniteUnknownsNewMod(IEventBus modEventBus) {
